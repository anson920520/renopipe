          ...
          columns1: [
            ...
            },
            {
              ...
              render: (h, params) => {
                ...
                // }, params.row.status === 0 ? '错误' : params.row.status === 1 ? '完成' : params.row.status === 2 ? '等待进行' : params.row.status === 3 ? '进行中' : params.row.status === -1 ? '异常' : '');
                }, params.row.status === 0 ? '错误' 
                : params.row.status === 1 ? '完成' 
                : params.row.status === 2 ? '等待进行' 
                : params.row.status === 3 ? '进行中' 
                : params.row.status === -1 ? '异常' : '');
              }
            },
            // {
            //   title: '门店',
